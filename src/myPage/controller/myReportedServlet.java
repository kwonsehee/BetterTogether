...
/**
 * Servlet implementation class myReportedServlet
 */
@WebServlet("/myPage/reported")
public class myReportedServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public myReportedServlet() {
        super();
...
//				int listCount = rs.getMyListCount(userId);
				int listCount = rs.getreportedMyListCount(userId);
...
//				ArrayList<Report> list = new ReportService().selectMyList(userId, pi);
				...
				RequestDispatcher view = request.getRequestDispatcher("/views/myPage/myReported.jsp");
