...
/**
 * Servlet implementation class joinedThreeMonthsSelectServlet
 */
@WebServlet("/joined/threeMonths")
public class joinedThreeMonthsSelectServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public joinedThreeMonthsSelectServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = ms.threeMonthsListCount(userId);
		System.out.println("threeMonths : " + listCount);
		...
		//1_2.페이징 처리를 위한 변수 선언 및 연산
				...
				//DateSelect ds = new DateSelect(Integer.parseInt(request.getParameter("threeMonths")), Integer.parseInt(request.getParameter("sixMonths")), Integer.parseInt(request.getParameter("oneyear")));
				
				ArrayList<Challenge> cList = ms.threeMonthsSelectList(pi, userId);
				...
				RequestDispatcher view = request.getRequestDispatcher("/views/myPage/joinedThreeMonthsChall.jsp");
