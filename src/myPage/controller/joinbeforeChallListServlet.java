...
/**
 * Servlet implementation class joinbeforeChallListServlet
 */
@WebServlet("/before/list")
public class joinbeforeChallListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public joinbeforeChallListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = ms.beforejoingetListCount(userId);
		System.out.println("beforejoin Count : " + listCount);
		...
		ArrayList<Challenge> cList = ms.beforejoingetList(pi, userId);
		...
		RequestDispatcher view = request.getRequestDispatcher("/views/myPage/joinbeforeChallenge.jsp");
