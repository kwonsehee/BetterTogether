...
/**
 * Servlet implementation class joinedSixMonthsSelectServlet
 */
@WebServlet("/joined/sixMonths")
public class joinedSixMonthsSelectServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public joinedSixMonthsSelectServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = ms.sixMonthsListCount(userId);
		System.out.println("sixmonth : " + listCount);
		...
		ArrayList<Challenge> cList = ms.sixMonthsSelectList(pi, userId);
		...
		RequestDispatcher view = request.getRequestDispatcher("/views/myPage/joinedSixMonthsChall.jsp");
