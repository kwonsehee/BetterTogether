...
/**
 * Servlet implementation class joinedYearSelectServlet
 */
@WebServlet("/joined/oneyear")
public class joinedYearSelectServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public joinedYearSelectServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = ms.oneyearListCount(userId);
		...
		ArrayList<Challenge> cList = ms.oneyearSelectList(pi, userId);
		...
		RequestDispatcher view = request.getRequestDispatcher("/views/myPage/joinedOneyearChall.jsp");
