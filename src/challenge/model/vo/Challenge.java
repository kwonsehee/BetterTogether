...
public class Challenge {
    ...
    * CHALL_NO   NUMBER
      ...
      CHALL_CONFIRM   VARCHAR2(1000 BYTE)
      CHALL_FREQUENCY   VARCHAR2(100 BYTE)
      CHALL_PERIOD   VARCHAR2(100 BYTE)
      CHALL_PAYMENT   NUMBER
      CHALL_CONTENT   VARCHAR2(2000 BYTE)
      CHALL_COUNT   NUMBER
   ...
   public Challenge(int challNo, String challTitle, int challPeople, Date challDate, int challHits, String challFile,
         ...
         int confirmCnt, String userId, String nickName, String cateName, int challCnt, String challStart) {
      super();
...
public void setUserId(String userId) {
   ...
   public int getChallHits() {
      return challHits;
   }

   public void setChallHits(int challHits) {
      this.challHits = challHits;
   }
