...
/**
 * Servlet implementation class QnAmylistServlet
 */
...
public class QnAmylistServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//세션에 저장된 유저 아이디값 가져오기
				...
				// 리스트 객체 생성하기
				ArrayList<QnA> list = new QnAService().selectMyList(userId, pi);
				...
				RequestDispatcher view = request.getRequestDispatcher("/views/qna/mylist.jsp");
