...
public class Review {
	...
	public Review(int rId, String rContent, Date createDate, Date modifyDate, int rGrade, int challNo, String status,
	...
	public String toString() {
		return "Review [rId=" + rId + ", rContent=" + rContent + ", createDate=" + createDate + ", modifyDate="
				+ modifyDate + ", rGrade=" + rGrade + ", challNo=" + challNo + ", status=" + status + ", userId="
