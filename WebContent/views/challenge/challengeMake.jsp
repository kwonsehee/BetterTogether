		...
		<form method="POST" id="challenge-form">
				...
				<table class="table">
					...
					<tr>
						...
						<td><input type="radio" id="weight" name="category"
							 value="체중관리"> <label>체중관리</label> <input type="radio"
							id="exercise" name="category" value="운동"> <label>운동</label>
							<input type="radio" id="certificate" name="category" value="자격증">
							<label>자격증</label> <input type="radio" id="money" name="category"
							value="돈관리"> <label>돈관리</label> <input type="radio"
							id="habit" name="category" value="생활습관"> <label>생활습관</label>
							<input type="radio" id="study" name="category" value="공부">
							<label>공부</label> <input type="radio" id="skill" name="category"
							value="업무스킬"> <label>업무스킬</label> <input type="radio"
							id="language" name="category" value="외국어"> <label>외국어</label>
						</td>
					</tr>
					...
					<tr>
						<th>인증 방법</th>
						<td><input type="text" name="device" maxlength="50" required>
						</td>
					</tr>
			...
			<section id="content-2">
				...
				<button id="challenge_btn">
					<a href="challengeBoard.html">챌린지 등록</a>
				</button>
			</section>
		</form>
	</section>
