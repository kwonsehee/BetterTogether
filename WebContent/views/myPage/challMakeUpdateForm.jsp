...
<%
	...
	if(ch.getChallConfirm() != null){
		...
		switch(challConfirm){
		case "1" : selectedConfirm[0] = "checked"; break;
		case "2" : selectedConfirm[1] = "checked"; break;
		case "3" : selectedConfirm[2] = "checked"; break;
		}
	}
		...
		<form action="<%=request.getContextPath()%>/chall/update"
			...
			<section id="content-1">
				<table class="table">
					...
					<tr>
						<th>인증 방법</th>
						<td><input type="radio" id="weekend" name="confirm" value="1" <%=selectedConfirm[0] %>>
							<label>주말</label>
							<input type="radio" id="weekday" name="confirm" value="2" <%=selectedConfirm[1] %>>
							<label>평일</label> <input type="radio" id="both" name="confirm" value="3" <%=selectedConfirm[2] %>>
							<label>상관없음</label></td>
					</tr>
					
					<tr>
						<th>인증 빈도</th>
						<td><input type="text" name="frequency" maxlength="50" value="<%= ch.getChallFrequency()%>"></td>
					</tr>

					<tr>
						<th>챌린지 기간</th>
						<td><input type="text" name="period" maxlength="50" value="<%=ch.getChallPeriod()%>"></td>
					</tr>
