...
<body>
	...
	<section id="con" class="content_css">
		<form id="qna-form"
			...
			<input type="text" id="write_title" name="title" value="<%= a.getQnaTitle() %>">
			
			<textarea cols="50" name="content" rows="5" style="resize: none;"><%= a.getQnaContent() %></textarea>
