...
<body>
	...
	<form id="qna-form" action="<%=request.getContextPath()%>/qna/update"
		method="post">
		<section id="btSection" class="btSection">
			...
			<table id="writebox">
				<tr>
					<td>
						<h1 class="title">Question Update</h1>
					</td>
				</tr>
				<tr>
					<td class="qnaTable"><input type="text" id="write_title"
						name="title" value="<%=q.getQnaTitle() %>" readonly></td>
				</tr>
				<tr>
					<td class="qnaTable"><textarea cols="50" id="contentBox"
							name="content" rows="15"><%=q.getQnaContent()%></textarea></td>
				</tr>
			...
			<div id="btnArea">
				<!-- 등록 버튼 , 나가기 버튼 -->
				<button type="button" id="back" class="Btn1" onclick="javascript:history.back();">취소</button>
