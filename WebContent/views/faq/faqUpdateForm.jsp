...
<%@ include file="../common/common_ui.jsp"%>
	<section id="con" class="content_css">
		<form id="qna-form" action="<%= request.getContextPath() %>/faq/update" method="post">
			...
			<input type="text" id="write_title" name="title" value="<%= f.getQnaTitle() %>">
			
			<textarea cols="50" name="content" rows="5" style="resize: none;"><%= f.getQnaContent() %></textarea>
